...
public class TopicScore {
  ...
  public TopicScore(int T, int D, double paramSum) {
  ...
  public void print(InstanceList docs, String fileName) {

    print(docs, 0.0, -1, fileName);
  }

  public void print(InstanceList docs, double threshold, int numTopics, String fileName) {
